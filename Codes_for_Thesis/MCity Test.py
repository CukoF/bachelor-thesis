...
X = dataset.iloc[[11, 16, 42, 81, 90, 94, 135, 154, 161, 196, 199, 229, 275, 295, 299, 569, 756, 786, 822, 1082, 3936, 9826, 10354, 10897, 11445, 12482, 12668, 12988, 13567, 15216, 16598, 17346, 17961], [6]].values
y = pd.to_numeric(dataset.loc[[11, 16, 42, 81, 90, 94, 135, 154, 161, 196, 199, 229, 275, 295, 299, 569, 756, 786, 822, 1082, 3936, 9826, 10354, 10897, 11445, 12482, 12668, 12988, 13567, 15216, 16598, 17346, 17961], 'Value'].values)
...
plt.title('Manchester City Overall vs Value (Linear Regression)')
plt.xlabel('Overall')
plt.ylabel('Value')
plt.show()
...
plt.title('Manchester City Truth or Bluff (Polynomial Regression)')
plt.xlabel('Overall')
plt.ylabel('Value')
plt.show()
