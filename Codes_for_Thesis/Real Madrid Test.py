...
X = dataset.iloc[[0, 8, 10, 14, 15, 39, 48, 64, 70, 71, 74, 93, 98, 213, 218, 326, 467, 709, 1057, 1091, 1956, 3375, 4674, 7604, 9514, 11632], [6]].values
y = pd.to_numeric(dataset.loc[[0, 8, 10, 14, 15, 39, 48, 64, 70, 71, 74, 93, 98, 213, 218, 326, 467, 709, 1057, 1091, 1956, 3375, 4674, 7604, 9514, 11632], 'Value'].values)
...
plt.title('Real Madrid CF Overall vs Value (Linear Regression)')
plt.xlabel('Overall')
plt.ylabel('Value')
plt.show()
...
plt.title('Real Madrid CF Truth or Bluff (Polynomial Regression)')
plt.xlabel('Overall')
plt.ylabel('Value')
plt.show()
