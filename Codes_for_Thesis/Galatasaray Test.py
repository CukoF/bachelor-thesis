...
X = dataset.iloc[[265, 341, 385, 445, 628, 629, 671, 1007, 1498, 1592, 1647, 2078, 2096, 2143, 2195, 2211, 2501, 2517, 2694, 2835, 3155, 4272, 4534, 4599, 9670, 13538, 14126, 14196, 14412], [6]].values
y = pd.to_numeric(dataset.loc[[265, 341, 385, 445, 628, 629, 671, 1007, 1498, 1592, 1647, 2078, 2096, 2143, 2195, 2211, 2501, 2517, 2694, 2835, 3155, 4272, 4534, 4599, 9670, 13538, 14126, 14196, 14412], 'Value'].values)
...
plt.title('Galatasaray SK Overall vs Value (Linear Regression)')
plt.xlabel('Overall')
plt.ylabel('Value')
plt.show()
...
plt.title('Galatasaray SK Truth or Bluff (Polynomial Regression)')
plt.xlabel('Overall')
plt.ylabel('Value')
plt.show()
