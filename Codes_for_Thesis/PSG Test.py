...
X = dataset.iloc[[2, 30, 34, 38, 83, 99, 124, 127, 140, 156, 234, 250, 314, 323, 378, 389, 423, 603, 991, 1178, 2453, 4735, 7995, 11214, 12142, 12227, 12409, 13783], [6]].values
y = pd.to_numeric(dataset.loc[[2, 30, 34, 38, 83, 99, 124, 127, 140, 156, 234, 250, 314, 323, 378, 389, 423, 603, 991, 1178, 2453, 4735, 7995, 11214, 12142, 12227, 12409, 13783], 'Value'].values)
...
plt.title('Paris Saint-Germain Overall vs Value (Linear Regression)')
plt.xlabel('Overall')
plt.ylabel('Value')
plt.show()
...
plt.title('Paris Saint-Germain Truth or Bluff (Polynomial Regression)')
plt.xlabel('Overall')
plt.ylabel('Value')
plt.show()
